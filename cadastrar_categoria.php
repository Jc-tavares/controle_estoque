...
<div class="container" style="margin-top:40px;width: 500px;">
	<h4 style="text-align:center;">Cadastro de Categoria</h4>
	<form action="_cadastrar_categoria.php" method="post">
		<div class="form-group">
			<input type="text" name="categoria" class="form-control" autocomplete="off" placeholder="Digite o nome da categoria">
